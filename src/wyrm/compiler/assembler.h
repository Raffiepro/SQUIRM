...
/*
TODO: Val una manera de com construir aixo i ja tenir llenguatge estaria moolt
bé
*/
...
class Assembler {
public:
  Assembler(Book *book, Nodes::Node *ast);
  ...
  void PushInstructions(std::vector<Instruction> *from,
